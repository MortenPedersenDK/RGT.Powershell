namespace RGT.Services.Core.Data
{
    public class EventCreationInformation
    {
        ...
        public string Type { get; set; } = "0"; // 0 = race, 1 = group ride
        public string BotsType { get; set; } = "1"; // 0 = pacing, 1 = real
        public string BotsReal { get; set; } = "0"; 
        public string BotsMode { get; set; } = "3"; // 0 = Distributed, 3 = beginner, 4 = Intermediate, 5 = expert, 6 = custom, 
        public string BotsNum { get; set; } = "0";
        public string BotsMinPwr { get; set; } = "70";
        public string BotsMaxPwr { get; set; } = "310";
        public string Private { get; set; } = "1"; // 0 = promoted, 1 = private
